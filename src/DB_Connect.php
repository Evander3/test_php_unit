...
class DB_Connect
{
    ...
    public function init_db_connection($db_name)
    {
        $user = 'root';
        $password = '';
    ...
    public function initialization(): PDO
    {
        $conn = init_db_connection();
        init_events_table($conn);
        init_records_table($conn);
        return $conn;
    }

    public function init_records_table(PDO $conn): void
    {
        $sql_event = "CREATE TABLE IF NOT EXISTS ".DB_NAME."records
                        (
    ...
    public function init_events_table(PDO $conn): void
    {
        $sql_events_table = "CREATE TABLE IF NOT EXISTS ".DB_NAME.".events
                            (
                                id INT PRIMARY KEY NOT NULL,
